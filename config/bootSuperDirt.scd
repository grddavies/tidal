...
s.options.numBuffers = 1024 _ 256; // increase this if you need to load more samples
s.options.memSize = 8192 _ 32; // increase this if you get "alloc failed" messages
s.options.numWireBufs = 64; // increase this if you get "exceeded number of interconnect buffers" messages
s.options.maxNodes = 1024 _ 32; // increase this if you are getting drop outs and the message "too many nodes"
...
// for example: ~dirt.loadSoundFiles("/Users/myUserName/Dirt/samples/_");
